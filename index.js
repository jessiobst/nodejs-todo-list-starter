...
//Aca captura todas las peticiones realizadas por el cliente
//get tasks y redirige, post tasks y redirige de acuerdo al metodo asignado
app.use("/tasks",tareasRouter);
//este metodo vamos a copiar para implementar los demas
